      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center px-4">
        <div className={`text-center max-w-4xl transition-all duration-1000 ${isVisible ? 'opacity-100 transform translate-y-0' : 'opacity-0 transform translate-y-10'}`}>
          ...
          <div className="mb-8">
            ...
            <h1 className="text-7xl font-black text-transparent bg-clip-text bg-gradient-to-r from-purple-400 via-pink-400 to-red-400 mb-2 tracking-tight">
              Pocket Portrait
            </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
            <Link 
              href="/auth"
              className="group relative bg-gradient-to-r from-purple-600 to-pink-600 text-white px-12 py-4 rounded-2xl text-lg font-bold hover:shadow-2xl hover:shadow-purple-500/25 transform hover:scale-105 transition-all duration-300"
            >
            ...
            <button className="text-white border-2 border-white/30 px-8 py-4 rounded-2xl text-lg font-semibold hover:bg-white/10 hover:border-white/50 transition-all duration-300 backdrop-blur-sm">
              Watch Demo
            </button>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 max-w-2xl mx-auto">
            ...
            <div className="text-center">
              ...
              <div className="text-gray-400 text-sm">Money Tracked</div>
            </div>
            <div className="text-center">
